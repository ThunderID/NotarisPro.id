			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="row">
					...
					<div class="col-9 d-flex justify-content-center">
						<div class="form mt-3 mb-3 font-editor" id="complete" style="width: 21cm; height: 29.7cm; background-color: #fff; padding-top: 2cm; padding-bottom: 3cm; padding-left: 5cm; padding-right: 1cm;">
...
@push('scripts')
	...
	$(".editor").keyup(function(){
		...
		$('p').each(function() {
	    	...
	    	var pageHeight 		= 904;
			if( $(this).filter(':visible').outerHeight(true) ) {
			    staticHeight += $(this).filter(':visible').outerHeight(true);
			}

		    totalPageBreak = $('.page-break').length + 1;

		    pageHeight 	= totalPageBreak * pageHeight;

		    if (staticHeight > pageHeight) {
		        var html = "<div class='page-break'>PAGEBREAK</div>"
				var sel, range;
