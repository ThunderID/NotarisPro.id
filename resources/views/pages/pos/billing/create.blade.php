		...
		@component('components.form', [ 
			...
			<header>
				<h1>Invoice
					<br/>
					<small>
						<small style="letter-spacing: 0.1em;">
			...
			<aside>
				<h1><span contenteditable>Catatan</span></h1>
				<div contenteditable>
					<p>Batas Pembayaran di Hitung 1 Bulan Sejak Invoice Dikeluarkan.</p>
				</div>
			</aside>
...
@push('styles')  
		...
		*[contenteditable]:hover, *[contenteditable]:focus, td:hover *[contenteditable], td:focus *[contenteditable], img.hover { background: #DEF; box-shadow: 0 0 1em 0.5em #DEF; }
		...
		header { margin: 0 0 3em;height: 100px; line-height: 0px; background: #FFF; }
...
@push('scripts')  
		...
		function parsePrice(number) {
			return number.toFixed(2).replace(/(\d)(?=(\d\d\d)+([^\d]|IDR))/g, '$1,');
		}
