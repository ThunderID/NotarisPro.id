...
<div class="sort">
	<h5 class="d-inline">{{ isset($title) ? $title : 'Urutan' }}</h5>
	<div class="dropdown d-inline">
		<button id="dropdownMenuSort" class="btn btn-outline-primary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
