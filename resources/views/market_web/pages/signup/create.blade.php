						...
						<fieldset>
							...
							<div class="form-group">
								...
								<select disabled type="text" name="pembayaran[paket]" class="f1-payment-plan form-control" id="f1-payment-plan">
									...
									<option value="trial" @if($page_datas->datas['plan']=='trial') selected @endif>Trial 14 Days</option>
								</select>
							</div>
							<div class="form-group">
								<label class="sr-only" for="f1-payment-method">Metode Pembayaran</label>
								<select type="text" name="pembayaran[metode]" class="f1-payment-method form-control" id="f1-payment-method">
