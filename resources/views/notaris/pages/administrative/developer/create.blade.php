...
@section('content')
	<div class="row">
		...
		@include('helpers.company_sidebar', ['active' => 'Developer'])
			...
			<div class="row">
				<div class="col-12 col-lg-10 col-xl-8">
					@component('components.form', [ 
						...
						'store_url' 	=> route('administrative.developer.update', ['id' => $page_datas->id]), 
						'update_url' 	=> route('administrative.developer.update', ['id' => $page_datas->id]), 
					])
