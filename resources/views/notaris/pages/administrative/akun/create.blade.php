			...
			<div class="row">
				<div class="col-12 col-lg-10 col-xl-8">
					@component('components.form', [ 
						...
						'store_url' 	=> route('administrative.akun.update', ['id' => $page_datas->id]), 
						'update_url' 	=> route('administrative.akun.update', ['id' => $page_datas->id]), 
					])
						...
						<fieldset class="form-group">
							<div class="row">
								<div class="col-12">
									...
									<input name="email" value="{{ old('email') ? old('email') : $page_datas->akun['email'] }}" class="form-control" type="text" required>
								</div>
							</div>
						</fieldset>
