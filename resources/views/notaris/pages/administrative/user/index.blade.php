...
@section('content')
	<div class="row">
		...
		<div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-9 scrollable_panel subset-menu subset-sidebar target-panel">
			...
			<div class="row">
				<div class="col-md-12">
					<a class="btn btn-sm btn-primary" href="{{route('administrative.user.create')}}">Tambah User</a>
				</div>
			</div>
				...
				<div class="col-md-12">
					<table class="table table-hover">
						...
						<tbody>
							...
							<tr class="clickable-row" data-href="{{route('administrative.user.edit', ['id' => $data['id']])}}">
								<td>
									{{ $data['nama'] }}
								</td>
								<td>
