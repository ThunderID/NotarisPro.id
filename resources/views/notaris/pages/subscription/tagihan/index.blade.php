		...
		<div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-9 scrollable_panel subset-menu subset-sidebar target-panel">
			...
			<div class="row">
				...
				<div class="col-3 text-right">
					<a class="btn btn-sm btn-primary" href="{{route('administrative.user.create')}}">
									...
									<div class="card-block">
										<div class="row">
											<div class="col-12 text-right">
												<a href="{{route('subscription.tagihan.bayar', ['nomor' => $value['nomor']])}}" class="btn btn-primary" target="__blank"> <i class="fa fa-money"></i> Bayar </a>

												<a href="{{route('subscription.tagihan.print', ['id' => $value['id']])}}" class="btn btn-secondary" target="__blank"> <i class="fa fa-print"></i> Print </a>
											</div>
										</div>
										@include('notaris.pages.subscription.tagihan.small_pieces_invoice', ['data' => $value, 'kantor' => $page_datas->active_office['kantor']])
									</div>
								</div>
							</div>
						@endforeach
