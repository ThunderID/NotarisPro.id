...
__webpack_require__("./resources/assets/js/plugins/editorQuill.js");
// plugin select2
__webpack_require__("./resources/assets/js/plugins/select2.js");

// ===================================


// module init
__webpack_require__("./resources/assets/js/modules/module.js");

/***/ }),

/***/ "./resources/assets/js/modules/akta/show.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/modules/arsip/form.js":
/***/ (function(module, exports) {

window.formArsip = {
	dataForm: null,
	update: function update(url) {
		var ajxFormArsip = window.ajax;
	...
	getInput: function getInput(container) {
...
/***/ "./resources/assets/js/modules/arsip/list.js":
/***/ (function(module, exports) {
 ...
 */
window.ArsipList = {
	getData: function getData(url, selectList) {
		var ajxArsip = window.ajax;
	...
	setList: function setList(data, container) {
		$.map(data, function (v, i) {
			var option = $("<option></option>");

			option.val(v._id).html(v._id + ' - ' + v.pemilik.nama).attr('data-list', '{' + v.lists + '}').attr('data-name', v.pemilik.nama);

			$(container).append(option);
		});
	},
	getDataDokumen: function getDataDokumen(url) {
		var ajxDokumen = window.ajax;
		...
		ajxDokumen.defineOnSuccess(function (respon) {
			...
			$.map(respon, function (v, i) {
				...
				var title = i.split('.');
				var field = title[title.length - 1].replace('@', '');

				if (field == 'nama') {
					$formGroup.append('<label class="text-uppercase">' + field.replace('_', ' ') + '</label>').append('<input class="form-control" name="' + field + '" value="' + v + '" />');
	...
	init: function init(param, container) {
...
window.ModuleModal = {
	modalDataDokumen: function modalDataDokumen(url) {
		$('#choose-data-modal').on('show.bs.modal', function (e) {
			...
			$(this).find('form').attr('data-action', url + '/' + idTarget + '/dokumen/update');

			window.ArsipList.getDataDokumen(urlArsip);
		});
	},
	modalHide: function modalHide(container) {
...
/***/ "./resources/assets/js/modules/module.js":
/***/ (function(module, exports, __webpack_require__) {

// call module use 
// module akta
__webpack_require__("./resources/assets/js/modules/akta/show.js");

// module arsip
__webpack_require__("./resources/assets/js/modules/arsip/list.js");
__webpack_require__("./resources/assets/js/modules/arsip/form.js");
...
window.editorUI = {
	...
	editorSingle: function editorSingle(selector) {
		...
		var dataArsip = function (_Embed) {
			_inherits(dataArsip, _Embed);

			function dataArsip() {
				_classCallCheck(this, dataArsip);

				return _possibleConstructorReturn(this, (dataArsip.__proto__ || Object.getPrototypeOf(dataArsip)).apply(this, arguments));
			}

			_createClass(dataArsip, null, [{
				key: 'create',
				value: function create(value) {
					var node = _get(dataArsip.__proto__ || Object.getPrototypeOf(dataArsip), 'create', this).call(this, value);
	...
	parsingData: function parsingData(editor, element) {
		var textValue = element.html();
		var textItem = element.attr('data-dokumen-item');
		var newTextValue = '@' + textValue + textItem + '@';
		var textObj = { text: textValue, value: textItem };
	...
	save: function save(editor) {
		var judulAkta = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.input-judul-akta').find('input').val();
	...
	helperAction: function helperAction(editor) {
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).on('click', '.data-dokumen', function (e) {
			e.preventDefault();
			window.editorUI.parsingData(editor, __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this));
		});
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__("./node_modules/jquery/dist/jquery.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_select2__ = __webpack_require__("./node_modules/select2/dist/js/select2.js");
...
window.Select2Input = {
	...
	select2tag: function select2tag() {
	...
	select2tagDynamic: function select2tagDynamic() {
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.select-tag-add').select2({
			tags: true,
			allowClear: true,
			tokenSeparator: [',', ' '],
			createTag: function createTag(params) {
				var term = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.trim(params.term);
	...
	select2TagCustom: function select2TagCustom() {
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.select-tag-custom').select2({
			tags: true
		}).on('change', function () {
			var $selected = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).find('option:selected');
			var $container = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('data-container'));
			var $list = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<ul class="list-unstyled">');

			$selected.each(function (k, v) {
				var $li = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<li class="mb-4"></li>');
				...
				$li.html($linkClose + __WEBPACK_IMPORTED_MODULE_0_jquery___default()(v).text() + $linkDetail);
				$li.children('a.destroy-tag-selected').off('click.select2-copy').on('click.select2-copy', function (e) {
					var $opt = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).data('select2-opt');

					$opt.attr('selected', false);
					$opt.parents('select').trigger('change');
				}).data('select2-opt', __WEBPACK_IMPORTED_MODULE_0_jquery___default()(v));
