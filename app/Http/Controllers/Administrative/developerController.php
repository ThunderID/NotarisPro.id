...
class developerController extends Controller
{
	...
	public function edit(Request $request)
	{
		...
		//3.initialize view
		$this->view							= view('notaris.pages.administrative.developer.create');
	...
	public function update(Request $request)
	{
		try {
			...
			return $this->generateRedirect(route('administrative.developer.edit', $this->active_office['kantor']['id']));
		} catch (Exception $e) {
			dd($e);
