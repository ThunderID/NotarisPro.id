...
class userController extends Controller
{
	...
	public function index(Request $request)
	{
		...
		//3.initialize view
		$this->view							= view('notaris.pages.administrative.user.index');
	...
	public function create(Request $request, $id = null)
	{
		...
		//3.initialize view
		$this->view							= view('notaris.pages.administrative.user.create');
	...
	public function store(Request $request, $id = null)
	{
		try {
			...
			return $this->generateRedirect(route('administrative.user.index'));
		} catch (Exception $e) {
			$this->page_attributes->msg['error']	= $e->getMessage();
			return $this->generateRedirect(route('administrative.user.edit', ['id' => $id]));
		}
	}
