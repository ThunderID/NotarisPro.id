...
namespace TImmigration\Pengguna\Models;

use TImmigration\Infrastructures\Guid\GuidTrait;

use TImmigration\Infrastructures\Exceptions\DuplicateException;

use TImmigration\Infrastructures\Models\BaseModel;
