		...
		foreach (range(0, 19) as $key) 
		{
			...
			$isi				= [
				...
				'paragraf'		=> [
					...
					['konten' 	=> '<p style="text-align: center;"><span class="medium-editor-mention-at medium-editor-mention-at" data-mention="@notaris.nama">'.$notaris_aktif['notaris']['nama'].'</span>&nbsp;</p>'],
					['konten' 	=> '<p style="text-align: center;">DAERAH KERJA <span class="medium-editor-mention-at" data-mention="@notaris.daerah_kerja">'.$notaris_aktif['notaris']['daerah_kerja'].'</span>&nbsp;</p>'],
					['konten' 	=> '<p style="text-align: center;">SK. Kepala Badan Pertanahan Nasional Nomor : <span class="medium-editor-mention-at" data-mention="@notaris.nomor_sk">'.$notaris_aktif['notaris']['nomor_sk'].'</span>&nbsp;</p>'],
					['konten' 	=> '<p style="text-align: center;">Tanggal <span class="medium-editor-mention-at" data-mention="@notaris.tanggal_pengangkatan">'.$notaris_aktif['notaris']['tanggal_pengangkatan'].'</span>&nbsp;</p>'],
					['konten' 	=> '<p style="text-align: center;"><span class="medium-editor-mention-at" data-mention="@notaris.alamat">'.$notaris_aktif['notaris']['alamat'].'</span>&nbsp;<span class="medium-editor-mention-at" data-mention="@notaris.telepon">'.$notaris_aktif['notaris']['telepon'].'</span>&nbsp;</p>'],
					['konten' 	=> '<p style="text-align: center;">------------------------------------------------------------------</p>'],
					['konten' 	=> '<p style="text-align: center;"><b>AKTA JUAL BELI</b></p>'],
					['konten' 	=> '<p style="text-align: center;">Nomor <span class="medium-editor-mention-at" data-mention="@akta.nomor">'.$nomor_akta.'</span>&nbsp;</p>'],
