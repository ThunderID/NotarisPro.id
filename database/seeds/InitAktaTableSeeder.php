		...
		foreach (range(0, 19) as $key) 
		{
			...
			$isi				= [
				...
				'paragraf'		=> [
					...
					['konten' 	=> '<ol><li><span class="medium-editor-mention-at" data-mention="@pihak.1.nama">'.$klien_1['nama'].'</span>&nbsp;lahir di <span class="medium-editor-mention-at" data-mention="@pihak.1.tempat_lahir">'.$klien_1['tempat_lahir'].'</span>&nbsp;pada tanggal <span class="medium-editor-mention-at" data-mention="@pihak.1.tanggal_lahir">'.$klien_1['tanggal_lahir'].'</span>&nbsp;Warga Negara Indonesia, <span class="medium-editor-mention-at" data-mention="@pihak.1.pekerjaan">'.$klien_1['pekerjaan'].'</span>&nbsp;bertempat tinggal di <span class="medium-editor-mention-at" data-mention="@pihak.1.alamat">'.$alamt_1.'</span>&nbsp;pemegang kartu tanda penduduk nomor <span class="medium-editor-mention-at" data-mention="@pihak.1.nomor_ktp">'.$klien_1['nomor_ktp'].'</span>&nbsp;<br><span class="medium-editor-mention-at medium-editor-mention-at">@pihak.1.deskripsi</span>&nbsp;<br>Selaku penjual, yang selanjutnya disebut sebagai<br>PIHAK PERTAMA</li>'],
					['konten' 	=> '<li><span class="medium-editor-mention-at" data-mention="@pihak.2.nama">'.$klien_2['nama'].'</span>&nbsp;lahir di <span class="medium-editor-mention-at" data-mention="@pihak.2.tempat_lahir">'.$klien_2['tempat_lahir'].',</span>&nbsp;pada tanggal <span class="medium-editor-mention-at" data-mention="@pihak.2.tanggal_lahir">'.$klien_2['tanggal_lahir'].'</span>&nbsp;Warga Negara Indonesia, <span class="medium-editor-mention-at" data-mention="@pihak.2.pekerjaan">'.$klien_2['pekerjaan'].'</span>&nbsp;bertempat tinggal di <span class="medium-editor-mention-at" data-mention="@pihak.2.alamat">'.$alamt_2.'</span>&nbsp;pemegang kartu tanda penduduk nomor <span class="medium-editor-mention-at medium-editor-mention-at" data-mention="@pihak.2.nomor_ktp">'.$klien_2['nomor_ktp'].'<br></span><span class="medium-editor-mention-at medium-editor-mention-at">@pihak.2.deskripsi</span><br>Selaku pembeli, yang selanjutnya disebut sebagai<br>PIHAK KEDUA<br></li></ol>'],
				],
				'mentionable'	=> [
					'@notaris.nama',
				...
				'fill_mention'	=> [
					...
					'@pihak.1.nama' 					=> $klien_1['nama'],
					'@pihak.1.tempat_lahir' 			=> $klien_1['tempat_lahir'],
					'@pihak.1.tanggal_lahir' 			=> $klien_1['tanggal_lahir'],
					'@pihak.1.pekerjaan' 				=> $klien_1['pekerjaan'],
					'@pihak.1.alamat' 					=> $alamt_1,
					'@pihak.1.nomor_ktp' 				=> $klien_1['nomor_ktp'],
					'@pihak.2.nama' 					=> $klien_2['nama'],
					'@pihak.2.tempat_lahir' 			=> $klien_2['tempat_lahir'],
					'@pihak.2.tanggal_lahir' 			=> $klien_2['tanggal_lahir'],
					'@pihak.2.pekerjaan' 				=> $klien_2['pekerjaan'],
					'@pihak.2.alamat' 					=> $alamt_2,
					'@pihak.2.nomor_ktp' 				=> $klien_2['nomor_ktp'],
				],
