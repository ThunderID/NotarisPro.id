		...
		foreach (range(0, 19) as $key) 
		{
			$isi				= [
				...
				'paragraf'		=> [
					...
					['konten' 	=> '<p style="text-align: center;"><span class="medium-editor-mention-at">@notaris.nama</span>&nbsp;</p>'],
					['konten' 	=> '<p style="text-align: center;">DAERAH KERJA <span class="medium-editor-mention-at">@notaris.daerah_kerja</span>&nbsp;</p>'],
					['konten' 	=> '<p style="text-align: center;">SK. Kepala Badan Pertanahan Nasional Nomor : <span class="medium-editor-mention-at">@notaris.nomor_sk</span>&nbsp;</p>'],
					['konten' 	=> '<p style="text-align: center;">Tanggal <span class="medium-editor-mention-at">@notaris.tanggal_pengangkatan</span>&nbsp;</p>'],
					['konten' 	=> '<p style="text-align: center;"><span class="medium-editor-mention-at">@notaris.alamat</span>&nbsp;<span class="medium-editor-mention-at">@notaris.telepon</span>&nbsp;</p>'],
					['konten' 	=> '<p style="text-align: center;">------------------------------------------------------------------</p>'],
					['konten' 	=> '<p style="text-align: center;"><b>AKTA JUAL BELI</b></p>'],
					['konten' 	=> '<p style="text-align: center;">Nomor <span class="medium-editor-mention-at">@akta.nomor</span>&nbsp;</p>'],
